...
/**
 *
 * @param {{test: string, from: string, to: string}} args
 */
function validateAndParseOptions(args) {
...
export const options = validateAndParseOptions(values);
